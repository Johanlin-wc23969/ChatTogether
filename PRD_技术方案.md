...
本项目是一款 iOS 匿名语音辩论聊天室。用户以随机匿名卡通身份进入 3-6 人房间，围绕系统随机生成的辩题进行正反方轮流发言。每次仅允许一名用户开麦，发言最长 60 秒，可提前结束。用户通过按钮申请进入发言队列，按钮有 30 秒冷却时间，避免频繁抢占发言机会。
